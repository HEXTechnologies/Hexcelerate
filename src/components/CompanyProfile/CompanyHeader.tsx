...
const CompanyHeader = ({
  ...
  const websiteButtonStyle = {
    ...
    padding: "6px 16px",
    borderRadius: "24px",
    backgroundColor: isLightMode ? "rgba(16, 185, 129, 0.1)" : "rgba(16, 185, 129, 0.15)",
    color: isLightMode ? "rgb(16, 185, 129)" : "rgb(34, 197, 94)",
    border: `1px solid ${isLightMode ? "rgba(16, 185, 129, 0.2)" : "rgba(34, 197, 94, 0.2)"}`,
...
const linkedInButtonStyle = {
    ...
    padding: "6px 16px",
    borderRadius: "24px",
    backgroundColor: isLightMode ? "rgba(0, 119, 181, 0.1)" : "rgba(0, 119, 181, 0.15)",
    color: isLightMode ? "rgb(0, 119, 181)" : "rgb(10, 102, 194)",
    border: `1px solid ${isLightMode ? "rgba(0, 119, 181, 0.2)" : "rgba(10, 102, 194, 0.2)"}`,
    transition: "all 0.2s ease",
    textDecoration: "none",
    fontSize: "0.875rem",
    fontWeight: 500,
